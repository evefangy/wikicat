...
if __name__ == "__main__":
    ...
    art_file = open("/Users/eve/Desktop/Wiki/Life/article_2.txt", "w")
    cate_file = open("/Users/eve/Desktop/Wiki/Life/category_2.txt", "w")
    ...
    start = 31790 #haven't run this category yet
    counter = start
    with open("/Users/eve/Desktop/Wiki/Life/category.txt",'r') as f:
        c = 0
        for line in f:
            line = line.strip('\n')
            seen.add(line)
